...
export default function Methodology() {
  ...
  return (
    <>
      <section className="w-screen py-60 select-none overflow-hidden">
        <div className="w-full flex flex-col gap-10">
          ...
          <div className="flex justify-between items-center w-full c-container-2">
            ...
            >
              Understanding your vision is where it all begins. We dive deep
              into your goals, audience, and challenges to uncover opportunities
              that drive impact. Research and collaboration lay the foundation
              for success.
            </motion.p>
          </div>
