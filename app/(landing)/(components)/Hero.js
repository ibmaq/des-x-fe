...
export const Hero = () => {
  return (
    <div className="h-full">
      <div className="flex flex-col gap-6 lg:gap-16 items-center justify-center pt-16 lg:pt-44 pb-36 max-sm:px-4 hero-container">
        <div className="text-center">
          <h1 className="font-bebas text-white text-18.5 md:text-49 leading-0.8 md:-tracking-5.04 text-center">
            ...
            <motion.div
              ...
              className="inline-flex overflow-hidden w-full max-sm:max-w-[232px]  max-w-max relative"
            >
              <motion.div
        ...
        <div className="w-full flex flex-col gap-8 items-center max-w-182 mx-auto">
          <p className="uppercase text-cust-white text-center -tracking-0.19 text-base/none lg:text-xl/6 font-medium">
            ...
            and drive results that matter. Bold, innovative, and tailored to
            your vision—we’re here to turn ideas into impact.
          </p>
